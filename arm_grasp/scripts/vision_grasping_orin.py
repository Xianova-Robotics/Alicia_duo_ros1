...
class GraspingDemo:
    def __init__(self, pregrasp_x, pregrasp_y, pregrasp_z, length, breadth):
        ...
        # 直接使用手眼标定结果创建变换矩阵
        # 平移部分
        #         trans = [0.2594505181139467, -0.0011344380191136358, 0.5332827013067664]#x,y,z

        # # 旋转部分（四元数）
        # rot = [0.6620481300298083, 0.5203583815535275, 0.41421236284738516, -0.34546714277252716]#w,x,y,z
        """

        translation: 
        x: 0.3386691856301935
        y: 0.010932772403258913
        z: 0.4555244933727863
        rotation: 
        x: -0.6750318965095816
        y: -0.02152222698097017
        z: 0.7358861331826768
        w: 0.048376972103515964
        ...
        """
        trans = [0.3386691856301935, 0.010932772403258913, 0.4555244933727863]#x,y,z
        # 旋转部分（四元数）
        # rot = [0.7262970835304973, -0.340610116123624, 0.3660512281389685, 0.4716818775692979]#w,x,y,z
        rot = [-0.6750318965095816, -0.02152222698097017, 0.7358861331826768, 0.048376972103515964]#w,x,y,z
