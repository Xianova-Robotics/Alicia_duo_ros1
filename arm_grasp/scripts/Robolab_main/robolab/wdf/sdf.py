...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(
        ...
        domainMax=1.0,
        device='cuda',
        assetRoot='/home/ubuntu/Github/Xianova_Robotics/Rofunc-secret/rofunc/simulator/assets',
        assetName='urdf/ycb/035_power_drill/035_power_drill.urdf',
        trainEpochs=1000,
        saveMeshDict=True
    )
    ...
    # 训练SDF模型
    asset_path = os.path.join(args.assetRoot, args.assetName)
