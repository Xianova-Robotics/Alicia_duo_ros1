...
print("---------- Forward kinematics for United Digital Human (UDH) using MJCF file ----------")
model_path = "/home/ubuntu/Github/Xianova_Robotics/Rofunc-secret//rofunc/simulator/assets/mjcf/hotu/hotu_humanoid.xml"
