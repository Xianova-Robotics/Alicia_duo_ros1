...
#include <ros/ros.h>
#include <serial_server_node/ArmJointState.h>  // Correct message type for ArmJointState
...
private:
    void feedbackCallback(const serial_server_node::ArmJointState::ConstPtr& msg);  // Changed to ArmJointState message type
