...
(cl:defclass <set_servo_as> (roslisp-msg-protocol:ros-message)
  ((servo_type_4
   ...
   (servo_target_cycle_u8
    ...
    :initform (cl:make-instance 'std_msgs-msg:UInt8MultiArray))
   (gripper_angle_u8
    :reader gripper_angle_u8
    :initarg :gripper_angle_u8
    :type std_msgs-msg:UInt8MultiArray
    :initform (cl:make-instance 'std_msgs-msg:UInt8MultiArray)))
)
...
(cl:ensure-generic-function 'servo_type_4-val :lambda-list '(m))
(cl:defmethod servo_type_4-val ((m <set_servo_as>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader frame_msgs-msg:servo_type_4-val is deprecated.  Use frame_msgs-msg:servo_type_4 instead.")
  (servo_type_4 m))
...
(cl:defmethod gripper_angle-val ((m <set_servo_as>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader frame_msgs-msg:gripper_angle-val is deprecated.  Use frame_msgs-msg:gripper_angle instead.")
  (gripper_angle m))
...
(cl:ensure-generic-function 'gripper_angle_u8-val :lambda-list '(m))
(cl:defmethod gripper_angle_u8-val ((m <set_servo_as>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader frame_msgs-msg:gripper_angle_u8-val is deprecated.  Use frame_msgs-msg:gripper_angle_u8 instead.")
  (gripper_angle_u8 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <set_servo_as>) ostream)
  "Serializes a message object of type '<set_servo_as>"
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'servo_type_4) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'gripper_angle) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'gripper_angle_u8) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <set_servo_as>) istream)
  "Deserializes a message object of type '<set_servo_as>"
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'servo_type_4) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'gripper_angle) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'gripper_angle_u8) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<set_servo_as>)))
  ...
  "9a90f2689947b28e8c629edf3384926d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'set_servo_as)))
  "Returns md5sum for a message object of type 'set_servo_as"
  "9a90f2689947b28e8c629edf3384926d")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <set_servo_as>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'gripper_angle))
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'gripper_angle_u8))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <set_servo_as>))
  "Converts a ROS message object to a list"
  (cl:list 'set_servo_as
    (cl:cons ':servo_type_4 (servo_type_4 msg))
    ...
    (cl:cons ':gripper_angle_u8 (gripper_angle_u8 msg))
))
