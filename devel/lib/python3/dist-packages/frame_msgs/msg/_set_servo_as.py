...
class set_servo_as(genpy.Message):
  _md5sum = "47ff6d7a480da9dc74da49bb9bec5dcf"
  _type = "frame_msgs/set_servo_as"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """std_msgs/Float32MultiArray servo_target_angle
...
"""
  __slots__ = ['servo_target_angle','servo_target_cycle','servo_target_angle_u8','servo_target_cycle_u8']
  _slot_types = ['std_msgs/Float32MultiArray','std_msgs/Float32MultiArray','std_msgs/UInt8MultiArray','std_msgs/UInt8MultiArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       servo_target_angle,servo_target_cycle,servo_target_angle_u8,servo_target_cycle_u8
